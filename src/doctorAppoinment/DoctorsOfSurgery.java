...
public class DoctorsOfSurgery extends JFrame implements ActionListener {
...
public void addElements(){
        ...
        try{ 
            BufferedReader br = new BufferedReader(new FileReader("src/doctorAppoinment/DoctorsOfSurgery.txt"));
	...
	public void actionPerformed(ActionEvent e) {
				if(doctorIdTextField.getText().equals("201")){
			JOptionPane.showMessageDialog(null, "You Successfully Set Appointment With Dr. Ashfaq Nipun ");
		}
				else if(doctorIdTextField.getText().equals("202")){
					JOptionPane.showMessageDialog(null, "You Successfully Set Appointment With Dr. Moumita Chatterji ");
				}
				else if(doctorIdTextField.getText().equals("203")){
					JOptionPane.showMessageDialog(null, "You Successfully Set Appointment With Dr. Shukanto Bisshash ");
				}
